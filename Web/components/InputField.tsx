...
export const InputField: React.FC<InputFieldProps> = (props) => {
  ...
  return (
    <div className="my-2 w-[300px] flex justify-center flex-col">
      <Field id={props.name} name={props.name} placeholder={props.placeholder} type={props.type} className="p-4 cursor-pointer rounded-lg" style={{ background: "rgba(0, 0, 0, 0.5)" }} />
